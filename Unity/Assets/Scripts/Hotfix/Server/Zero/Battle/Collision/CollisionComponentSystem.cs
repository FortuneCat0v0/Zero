...
namespace ET.Server
{
    ...
    {
        [EntitySystem]
        private static void Awake(this CollisionComponent self)
        {
        ...
        [EntitySystem]
        private static void FixedUpdate(this CollisionComponent self)
        {
        ...
        public static void AddCollider(this CollisionComponent self, EColliderType colliderType, Vector2 vec2, Vector2 offset, bool isSensor,
        ...
        private static void SyncColliderBody(this CollisionComponent self)
        {
