...
{
    [Config]
    public partial class LocalizeConfig_Excel_CHTCategory : Singleton<LocalizeConfig_Excel_CHTCategory>
    {
        ...
        public Dictionary<string, LocalizeConfig_CHT> DataMap => _dataMap;
